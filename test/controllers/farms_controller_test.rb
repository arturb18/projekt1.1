...
class FarmsControllerTest < ActionController::TestCase
  ...
  test "should create farm" do
    assert_difference('Farm.count') do
      post :create, farm: { address: @farm.address, description: @farm.description, email: @farm.email, name: @farm.name, offer: @farm.offer, phone: @farm.phone }
    end
  ...
  test "should update farm" do
    patch :update, id: @farm, farm: { address: @farm.address, description: @farm.description, email: @farm.email, name: @farm.name, offer: @farm.offer, phone: @farm.phone }
    assert_redirected_to farm_path(assigns(:farm))
  end
